...
Source for [liachely.github.io](https://liachely.github.io), Lia Che's personal archive and portfolio. The public site uses the al-folio Jekyll theme; the private `liachely.github.io0` repository remains the untouched template source.

Main sections: Atlas of Care, Projects, Photography, and About. Earlier placeholder README contents are preserved in `docs/legacy-production-readmes.md`.
